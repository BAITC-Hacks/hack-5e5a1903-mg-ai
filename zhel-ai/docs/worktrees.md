...
Важно: меняются только `FRONTEND_PORT`, `BACKEND_PORT`, `DB_PORT`, `ML_PORT`
...
| Слот | frontend | backend | postgres | ml   | weather | Кому                   |
|------|----------|---------|----------|------|---------|------------------------|
| 0    | 3000     | 8000    | 5432     | 8010 | 8020    | основной чекаут (main) |
| 1    | 3001     | 8001    | 5433     | 8011 | 8021    | свободный слот         |
| 2    | 3002     | 8002    | 5434     | 8012 | 8022    | свободный слот         |
| 3    | 3003     | 8003    | 5435     | 8013 | 8023    | свободный слот         |
| 4    | 3004     | 8004    | 5436     | 8014 | 8024    | свободный слот         |

Колонки `ml` и `weather` — это `ML_PORT` и `WEATHER_PORT`. Наружу эти сервисы
