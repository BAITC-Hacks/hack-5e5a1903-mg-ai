...
- до 05.08.2024 включительно в Single Runs нет прогонов 06z и 18z IFS, только 00z и 12z.
  Это 144 прогона 18z, на их месте as-of возьмет 12z предыдущего дня. 00z их не заменит:
  он публикуется в 07:30 UTC, позже выпуска;
- 04.08–09.08.2025 архив Open-Meteo поврежден: нет прогонов 12z 08.08, 18z 04.08
  и 18z 07.08, а у девяти прогонов этих дней часть переменных пуста целиком. Повторный
  запрос отдает то же самое;
